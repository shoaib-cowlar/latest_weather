<template>
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    ...
    >
      ...
      <p
        class="block py-2 pl-3 pr-4 text-gray-900 rounded cursor-pointer hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
      >
      ...
      >
        ...
        <li v-if="authenticatedUser" @click="logout">
          <a
            href="#"
...
import { getAccessToken, parseUserInfo } from "../../helpers";
...
onMounted(() => {
  ...
  authenticated.value = getAccessToken() || false;
  console.log(authenticated.value);
  if (authenticated.value) {
    authenticatedUser.value = parseUserInfo().firstName;
  }
});
</script>
